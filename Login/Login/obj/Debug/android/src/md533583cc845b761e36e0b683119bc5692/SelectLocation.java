...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Login.SelectLocation, Login, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SelectLocation.class, __md_methods);
	}


	public SelectLocation () throws java.lang.Throwable
	{
		super ();
		if (getClass () == SelectLocation.class)
			mono.android.TypeManager.Activate ("Login.SelectLocation, Login, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
