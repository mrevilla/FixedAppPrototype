...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Login.EventMap, Login, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", EventMap.class, __md_methods);
	}


	public EventMap () throws java.lang.Throwable
	{
		super ();
		if (getClass () == EventMap.class)
			mono.android.TypeManager.Activate ("Login.EventMap, Login, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
